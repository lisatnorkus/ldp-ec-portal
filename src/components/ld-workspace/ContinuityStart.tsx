...
import { startPackage } from "./continuity-actions";

export function ContinuityStart({ ldNumber }: { ldNumber: number }) {
  ...
  function begin() {
    ...
    startTransition(async () => {
      const res = await startPackage(ldNumber, cycle.trim() || "current", {
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--color-ldp-ink-900)]">
            A handoff package is the record of your time as chair — state-of-the-LD, key
            contacts, open tasks, precinct notes, and a personal message to your successor.
            It stays locked in the LD&apos;s history after submission so continuity survives
